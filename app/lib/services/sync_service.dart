...
class SyncService {
  ...
  /// from meaning "erase my progress".
  ...
  static Future<void> push() async {
    ...
    // push that outlived a sign-out would still be accepted by the server,
    // which falls back to the uid header while REQUIRE_AUTH_TOKEN is off.
    try {
