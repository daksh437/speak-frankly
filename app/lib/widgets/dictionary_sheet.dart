...
void showDictionarySheet(BuildContext context, String word) {
  // Spaces survive. They used to be stripped along with the punctuation, which
  // was fine for a tapped word but silently welded multi-word entries together
  // — Word of the Day sends phrases like "by the way", and the sheet went off
  // and failed to look up "bytheway", then said so to the learner.
  final cleaned = word
