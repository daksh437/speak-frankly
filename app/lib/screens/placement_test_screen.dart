...
class _PlacementTestScreenState extends State<PlacementTestScreen> {
  ...
  /// score was measured, shown, and then thrown away, so someone who could not
  /// say a word of it was still placed on their written answers alone.
  ///
  /// A skipped check changes nothing, and neither does one the microphone heard
  /// nothing in: silence is a device problem, not a level.
