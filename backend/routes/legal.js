...
<ul>
  ...
  <li>For a first-time subscription billed by Razorpay, you may request a refund within <b>2 days</b> of the charge by emailing <a href="mailto:${CONTACT}">${CONTACT}</a>.</li>
